...
},{"blueimp-load-image":"../node_modules/blueimp-load-image/js/index.js"}],"../node_modules/parseuri/index.js":[function(require,module,exports) {
/**
 * Parses an URI
 *
...
},{"./url":"../node_modules/socket.io-client/lib/url.js","socket.io-parser":"../node_modules/socket.io-parser/index.js","./manager":"../node_modules/socket.io-client/lib/manager.js","debug":"../node_modules/socket.io-client/node_modules/debug/src/browser.js","./socket":"../node_modules/socket.io-client/lib/socket.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
var socket = (0, _socket.default)("".concat(window.location.host, "/review"));
console.log(socket);

var loadDecals = function loadDecals() {
...
loadDecals().then(function (loadedDecals) {
  loadedDecals.forEach(function (decal) {
    var decalThumb = decal.url;
...
socket.on("server:refresh", function (msg) {
  document.querySelectorAll('canvas').forEach(function (decal) {
...
},{"../utils/loadImage":"../utils/loadImage.js","socket.io-client":"../node_modules/socket.io-client/lib/index.js"}]},{},["review.js"], null)
//# sourceMappingURL=/review/review.c2fbd4e1.js.map