...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"../node_modules/hyperscript-attribute-to-property/index.js":[function(require,module,exports) {
...
},{"blueimp-load-image":"../node_modules/blueimp-load-image/js/index.js"}],"events.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            file = _context.sent;
            return _context.abrupt("return", (0, _loadImage.default)({
              url: file,
              censored: false
            }));
...
},{"../utils/loadImage":"../utils/loadImage.js"}],"../constants.js":[function(require,module,exports) {
"use strict";
...
},{}],"../utils/crop.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./canvas":"../utils/canvas.js"}],"../utils/mask.js":[function(require,module,exports) {
"use strict";
...
},{"./canvas":"../utils/canvas.js","../constants":"../constants.js"}],"phone.js":[function(require,module,exports) {
"use strict";
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(imageID) {
    var id, input, image, loading, dots, dot, type, dotInterval, canvasSize, maskedImage, done;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 7:
            ...
            socket.emit('phone:uploadImage', {
              imageSrc: (0, _crop.default)(image.url, canvasSize).toDataURL(),
              size: canvasSize,
              id: id
            });
            _context.next = 19;
          ...
          case 19:
            ...
            maskedImage = new _mask.MaskedImage({
              image: (0, _crop.default)(image.url, [canvasSize[0] * DPR, canvasSize[1] * DPR]),
              mode: 'subtract',
              scale: DPR
            });
...
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","nanohtml":"../node_modules/nanohtml/lib/browser.js","socket.io-client":"../node_modules/socket.io-client/lib/index.js","./events":"events.js","../constants":"../constants.js","../utils/crop":"../utils/crop.js","../utils/mask":"../utils/mask.js"}]},{},["phone.js"], null)
//# sourceMappingURL=/phone.24d0524b.js.map