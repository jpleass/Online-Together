...
},{"regenerator-runtime":"VqhU"}],"tuDi":[function(require,module,exports) {
...
socket.on('connect_error', function (error) {
  log('there is an connect error');
  log(error.name + ': ', error.message);
  log(error);
});
socket.on('server:isProjectorConnected', function (message) {
  log(message);
});
...
},{"@babel/runtime-corejs2/regenerator":"i9LV","@babel/runtime-corejs2/helpers/asyncToGenerator":"OYLD","@babel/runtime-corejs2/core-js/object/assign":"h2Mz","@babel/runtime-corejs2/helpers/taggedTemplateLiteral":"fQ8b","nanohtml":"zpjE","socket.io-client":"+1g+","./events":"Bvf5","../constants":"gIeR","../utils/crop":"yVVH","../utils/mask":"RH6Q"}]},{},["+N3k"], null)
//# sourceMappingURL=/phone.ac61aadb.js.map